...
function App() {
  //La fucnción(la derecha) modificara el state(izquierda)
  ...
  useEffect(() =>{
    //'Se ejecuta cuando el componente este listo... o la cantidad cambió o los mesese...'
  ...
  return (
    <div className="my-20 max-w-lg mx-auto bg-white shadow p-10">
          {<Header /> /*Importado el h1 del componente Header */}
